...
Sound.prototype.play = function(onEnd,visualizer) {
  var subscriptionIos, subscriptionAndroid;
  

  if (visualizer) {
      if (NativeAppEventEmitter.addListener)
        subscriptionIos = NativeAppEventEmitter.addListener('MusicVisualizer', visualizer);
      if (DeviceEventEmitter.addListener)
        subscriptionAndroid = DeviceEventEmitter.addListener('MusicVisualizer', visualizer);
  }
  if (this._loaded) {
