...
<module external.linked.project.id=":RNSound" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" external.system.module.group="xummerMusic" external.system.module.version="unspecified" type="JAVA_MODULE" version="4">
